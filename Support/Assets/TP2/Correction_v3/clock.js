...
let alarmesDeclenchees = []; // Un tableau pour garder toutes les alarmes
 ...
 * @param  {number} max      ajoute les options 0 à max
 * @param  {string} selectId identifiant du selet concerné
 */
